...
- A zero-input vector generates a default output of `1'b0`, which is not handled separetly here.
...
- Zero-input vectors are easily handled by performaing a reduction-OR on the input `isZero = |in`.

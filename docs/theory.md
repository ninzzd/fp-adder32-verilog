...
However, a noticeable flaw in this incomplete representation is that only fractional numbers and integers greater than or equal to 1 can be represented. This implies that normalized numbers with exponents less than 0 must also be represented. This is achieved through exponent biasing.
